...
CREATE TABLE "CHARACTER_SKIN" (
    ...
    "REWARD" CHAR(1) DEFAULT 'N' CHECK(REWARD IN('Y','N')) NOT NULL
);
...
COMMENT ON COLUMN "CHARACTER_SKIN"."REWARD" IS '보상용인지 여부(Y/N)';
...
COMMENT ON COLUMN "CHATTING"."CONTENT" IS '채팅내용(50글자)';
...
CREATE TABLE "LOGIN_API" (
	"USER_ID"	VARCHAR2(20)		NOT NULL,
	"API_KIND"	NVARCHAR2(10)		NOT NULL,
...
ALTER TABLE "CHATTINGROOM" ADD CONSTRAINT "FK_MEMBER_TO_CHATTINGROOM_2" FOREIGN KEY (
	"USER_ID"
)
REFERENCES "MEMBER" (
	"USER_ID"
...
ALTER TABLE "CHARACTER" ADD CONSTRAINT "FK_SKIN_TO_CHARACTER_1" FOREIGN KEY (
	"SKIN_ID"
)
REFERENCES "CHARACTER_SKIN" (
	"SKIN_ID"
