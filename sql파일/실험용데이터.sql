...
BEGIN 
    ...
    -- 실험용 유저 데이터 추가 
		...
		VALUES( 't'||SEQ_TEST.NEXTVAL , 't'||SEQ_TEST.CURRVAL, 'NIC'||SEQ_TEST.CURRVAL);
...
BEGIN 
    ...
    -- 실험용 유저 데이터 추가 
		...
		VALUES( 't'||SEQ_TEST.NEXTVAL , 't'||SEQ_TEST.CURRVAL, 'NIC'||SEQ_TEST.CURRVAL, 'N');
        ...
        INSERT INTO MEMBER(USER_ID, USER_PWD, NICKNAME, STATUS)
		VALUES( 't'||SEQ_TEST.NEXTVAL , 't'||SEQ_TEST.CURRVAL, 'NIC'||SEQ_TEST.CURRVAL, 'X');
