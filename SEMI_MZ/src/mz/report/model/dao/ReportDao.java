...
//------------------------------ select 구간 -------------------------------
	...
	public ArrayList<Report> selectReportPart(Connection conn, int page, String search, String keyword) {
		...
		try {
			...
			while (rset.next()) {
				Report r = new Report(rset.getInt("REPORT_NO"), rset.getString("USER_ID"), rset.getString("RECEIVE_ID"),
						rset.getString("REPORT_TITLE"), rset.getString("REPORT_CONTENT"),
	...
	public Report selectReport(Connection conn, int reportNo) {
		...
		try {
			...
			if (rset.next()) {
				r = new Report(rset.getInt("REPORT_NO"), rset.getString("USER_ID"), rset.getString("RECEIVE_ID"),
						rset.getString("REPORT_TITLE"), rset.getString("REPORT_CONTENT"),
...
//------------------------------ insert 구간 -------------------------------
	...
	// 신고 정보 db 저장 - 가영
	public int insertReport(Connection conn, String userId, String receiveId, String reportTitle,
