...
<body>
	...
	-->
		<button class="alert-toggle button board-update-btn" id="test1">수정</button>
		<button class="alert-toggle button board-delete-btn" id="test2">삭제</button>
	...
	<div class="alert-overlay"></div> <!-- alert 창 실행시 뒷배경 오버레이 태그 -->
